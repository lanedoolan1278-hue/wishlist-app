...
function App() {
  ...
  const addItem = async () => {
    ...
    try {
      ...
      fetchItems();
    } catch (err) { alert("Save failed. Function not found."); }
  };
  ...
  return (
    <div style={{ backgroundColor: '#fcf2e6', minHeight: '100vh', padding: '40px 20px', fontFamily: "'Syne', sans-serif" }}>
      ...
      <div style={{ textAlign: 'center', marginBottom: '50px' }}>
        <h1 style={{ fontSize: '6rem', color: '#b1f2ba', fontWeight: '800', textShadow: '6px 6px 0px #ffb6c1, 12px 12px 0px #1a1a1a', WebkitTextStroke: '2px #1a1a1a' }}>WISHLIST</h1>
